...
More Atoms can be found in the [Atoms](../category/atoms) section.

### Preset Atoms

In addition to creating your own custom Atoms, Atomik also contains some preset atoms for ease of use. You can find them under [preset atoms](../atoms/preset-atoms.mdx). One example of a preset is the `FigmaShapeAtom` which contains data entered in a Figma component.
