...
Atomik is a Kotlin Multiplatform library that acts as an implementation of a design system in your shared code. It allows you to share design information in common code, and apply it to your UI with ease. It's in an experimental early stage, and should be used for testing purposes only.
...
**Components**:
* [Atoms](./core-concepts/atoms.md) - The building blocks of Atomik. Modular UI data that can be applied to the UI
* Molecules and beyond - A hierarchy of atom groups, each containing multiple of the subgroup
...
* [AtomikColor](./core-concepts/colors.md) - A common representation of Color, either with Hex or RGBA values
...
These calls will be updated in the future to be more global
